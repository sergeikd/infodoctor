...
namespace Infodoctor.Web
{
    public class AppDbInitializer : DropCreateDatabaseAlways<AppDbContext>
    {
        protected override void Seed(AppDbContext context)
        {
            ...
            var dp148 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp273 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp340 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp411 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp595 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp629 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp720 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp848 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp928 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp1010 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp1125 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp1246 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp1367 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp1460 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp1567 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp168 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp1768 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp188 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp1911 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp2087 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp2144 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp2257 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp2393 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp2472 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp2595 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp2654 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp2758 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp2833 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp2998 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp3027 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp3164 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp320 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp3318 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp3462 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp3519 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp3656 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp3767 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp386 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp3922 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp4019 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp4180 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp4251 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp4351 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp4463 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp4557 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp4698 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp4751 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp4813 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp4935 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp5029 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp514 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp5288 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp5385 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp5489 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp5515 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp5691 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp5779 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp5867 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp5915 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp6041 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp6171 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp6287 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp6349 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp641 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
            ...
            var dp6546 = new DoctorSpecialization()
            {
                LocalizedDoctorSpecializations = new List<LocalizedDoctorSpecialization>()
                {
                    new LocalizedDoctorSpecialization()
