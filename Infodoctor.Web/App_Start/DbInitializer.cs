        ...
        protected override void Seed(AppDbContext context)
        {
            ...
            var resort1 = new Resort()
            {
                ...
                Localized = new List<LocalizedResort>()
                {
                    ...
                    {
                        Name = "Санаторий \"Буг\"",
                        Manipulations = @"Медицинская база, Диагностическая база, Лечебные комплексы",
                        Language = langs.First(l => l.Code.ToLower() == "ru")
                    }
                }
            };
            ...
            var resort4 = new Resort()
            {
                Localized = new List<LocalizedResort>()
                {
                    new LocalizedResort()
                    {
                        ...
                        Manipulations = @" магнитно-резонансная томография
