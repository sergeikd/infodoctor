        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                if (!string.IsNullOrEmpty(token))
                {
                    ...
                    var callbackUrlLocal = $"{localDomain}/email/confirm?email={user.Email}&token={token}";
